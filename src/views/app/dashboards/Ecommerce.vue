        ...
        <b-colxx xl="6" lg="12">
            <div class="icon-cards-row">
                <glide-component :settings="glideIconsOption">
                    <icon-card :title="$t('dashboards.pending-requests')" icon="iconsminds-clock" :value="14" />
                    <icon-card :title="$t('dashboards.accepted-requests')" icon="iconsminds-basket-coins" :value="32" />
                    <icon-card :title="$t('dashboards.total-requests')" icon="iconsminds-arrow-refresh" :value="74" />
