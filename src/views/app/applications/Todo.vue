        ...
        <b-colxx xxs="12">
            <div class="mb-2">
                ...
                <div class="top-right-button-container">
                    ...
                    <b-modal id="modalright" ref="modalright" :title="$t('todo.add-new-title')" modal-class="modal-right">
                        <b-form>
            ...
            <b-row v-if="isLoad" key="itemList">
                <b-colxx xxs="12" v-for="(item,index) in items" :key="`item${index}`">
                    <todo-list-item :key="item.id" :data="item" :selected-items="selectedItems" @toggle-item="toggleItem" v-contextmenu:contextmenu />
                </b-colxx>
            </b-row>
